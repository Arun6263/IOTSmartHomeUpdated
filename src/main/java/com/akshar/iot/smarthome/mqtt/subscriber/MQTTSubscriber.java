...
import com.akshar.iot.smarthome.configuration.MQTTConfig;
...
public class MQTTSubscriber extends MQTTConfig implements MqttCallback, MQTTSubscriberBase {
	...
	public void subscribeMessage(String topic) {
		try {
		//	logger.info("------------subscribeMessage------before-----");
	...
	protected void config() {
		...
		logger.info("------------MQTT Subscriber---------TCP : "+ this.TCP);
		logger.info("------------MQTT Subscriber---------broker : "+this.broker);
		logger.info("------------MQTT Subscriber---------port : " +this.port);
